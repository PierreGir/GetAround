...
module Level5
    def self.run_main
        ...
        price_strategy_level_5 = PriceStrategyLevel5.new
        rentals.each do |rental|
            rental.compute_price(price_strategy_level_5)
            rental.compute_actions(price_strategy_level_5)
          end

        # Write output data
        output_data = serialize(rentals, with_options = true)
