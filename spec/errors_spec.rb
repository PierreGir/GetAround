...
RSpec.describe 'Common functions' do
  ...
  let(:invalid_json_input_path) { 'spec/data/invalid_json_input.json' }
  let(:incomplete_data_input_path) { 'spec/data/incomplete_data_input.json' }
